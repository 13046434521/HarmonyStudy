"use strict";
var e = require("fs"), t = require("path"), n = require("os"), r = require("crypto"),
    u = require("child_process"), o = require("constants"), i = require("stream"),
...
var D = d(e), p = d(t), E = d(n), m = d(r), h = d(u), y = d(o), C = d(i), F = d(s), g = d(c),
    A = d(a), v = d(l), S = d(f),
...
j.hasNpmPackInPaths = function (e, t) {
    ...
    e.PNPM_VERSION = "7.30.0", e.checkNpmConifg = function () {
        ...
        const n = (0, s.getNpmPath)(), r = (0, l.spawnSync)(n, ["config", "get", "prefix"], {
...
} }, ue = y.default, oe = process.cwd, ie = null,
...
function Oe(e) {
    ...
    a && (D.prototype = Object.create(a.prototype), D.prototype.open = function () {
        ...
        d = e
    }, enumerable: !0, configurable: !0 }), Object.defineProperty(e, "WriteStream", {
        get: function () {
            return D
        },
        set: function (e) {
...
function _e() {
    for (var e = Date.now(),
        t = 0;t < me[pe].length; ++t) me[pe][t].length > 2 && (me[pe][t][3] = e, me[pe][t][4] = e);
    Be()
}
...
var et = {
    ...
    checkPathsSync: function (e, t, n, r) {
        const {srcStat:u,destStat:o} = function(e, t, n){
            let r;
            const u = n.dereference ? e => ze.statSync(e, { bigint: !0 }) : e => ze.lstatSync(e, {
                bigint: !0
            }), o = u(e);
            try {
                r = u(t)
...
function St(e, t, n) {
    mt.readdirSync(e).forEach((r => function(e, t, n, r){
        const u = ht.join(t, e), o = ht.join(n, e),
...
const rn = re.fromCallback, un = p.default, on = we, sn = $e, cn = Ge.pathExists,
    {areIdentical:an} = et;
...
const hn = re.fromCallback, yn = p.default, Cn = ne, Fn = $e.mkdirs, gn = $e.mkdirsSync,
    An = pn.symlinkPaths, vn = pn.symlinkPathsSync, Sn = mn.symlinkType, wn = mn.symlinkTypeSync,
    On = Ge.pathExists, {areIdentical:bn} = et;
...
var ir = or;
const sr = we, cr = p.default, ar = Ot.copy, lr = Gt.remove, fr = $e.mkdirp, dr = Ge.pathExists,
    Dr = et;
...
function Vr() {
    return Lr ? Mr : (Lr = 1, Mr = (e, t = process.argv) => {
        const n = e.startsWith("-") ? "" : 1 === e.length ? "-" : "--", r = t.indexOf(n + e),
            u = t.indexOf("--");
        return -1 !== r && (-1 === u || r < u)
    })
}
...
function Ur() {
    return Hr || (Hr = 1, function(e, t){
        ...
        t.init = function (e) {
            ...
            if (u) {
                const t = this.color, u = "[3" + (t < 8 ? t : "8;5;" + t),
                    o = `  ${u};1m${r} [0m`;
...
const Kr = F.default, qr = Nr.exports("log4js:configuration"), Yr = [], Xr = [], Zr = e =>!e,
    Qr = e => e && "object" == typeof e && !Array.isArray(e), eu = (e, t, n) => {
        (Array.isArray(t) ? t : [t]).forEach((t => {
            if (t) throw new Error(`Problem with log4js configuration: (${Kr.inspect(e, {
                depth: 5
            })}) - ${n}`)
        }))
    };
...
!function(e){
    ...
    function r(r, u) {
        ...
        var o = n(u.getDate()), i = n(u.getMonth() + 1), s = n(u.getFullYear()),
            c = n(s.substring(2, 4)), a = r.indexOf("yyyy") > -1 ? s : c, l = n(u.getHours()),
            f = n(u.getMinutes()), d = n(u.getSeconds()), D = t(u.getMilliseconds(), 3),
            p = function(e){
    ...
    e.exports = r, e.exports.asString = r, e.exports.parse = function (t, n, r) {
        ...
        return function(t, n, r){
            var o = t.indexOf("O") < 0, i = !1,
                s = [{ pattern: /y{1,4}/, regexp: "\\d{1,4}", fn: function (e, t) {
                    u(e, "FullYear", t, o)
...
const {parse:Su,stringify:wu} = JSON, {keys:Ou} = Object, bu = String, _u = "string", Bu = {},
    Pu = "object", ku = (e, t) => t, xu = e => e instanceof bu ? bu(e) : e,
    Nu = (e, t) => typeof t === _u ? new bu(t) : t, Iu = (e, t, n, r) => {
        const u = [];
        ...
        const n = Su(e, Nu).map(xu), r = n[0], u = t || ku,
...
const Lo = we, jo = p.default, $o = 10, Ho = 5, Jo = 0, Go = process.versions.node.split("."),
    Vo = Number.parseInt(Go[0], 10), Uo = Number.parseInt(Go[1], 10),
...
const Es = yo.fromCallback, ms = p.default, hs = we, ys = Io.mkdirs, Cs = Io.mkdirsSync,
    Fs = ds.symlinkPaths, gs = ds.symlinkPathsSync, As = ps.symlinkType, vs = ps.symlinkTypeSync,
    Ss = fi.pathExists;
...
const rc = we, uc = p.default, oc = bi.copy, ic = Ji.remove, sc = Io.mkdirp, cc = fi.pathExists,
    ac = Zo;
...
const bc = Nr.exports("streamroller:RollingFileWriteStream"), _c = mo.exports, Bc = p.default,
    Pc = E.default, kc = () => new Date, xc = nu.exports, {Writable:Nc} = C.default,
    Ic = ({file:e,keepFileExt:t,needsIndex:n,alwaysIncludeDate:r,compress:u,fileNameSep:o}) => {
        let i = o || ".";
        const s = Fc.join(e.dir, e.name), c = t => t + e.ext,
            a = (e, t, r) =>!n && r || !t ? e : e + i + t,
            l = (e, t, n) => (t > 0 || r) && n ? e + i + n : e,
            f = (e, t) => t && u ? e + ".gz" : e, d = t ? [l, a, c, f] : [c, l, a, f];
...
var ea = {};
const ta = Nr.exports("log4js:fileSync"), na = p.default, ra = D.default,
    ua = E.default.EOL || "\n";
...
const la = p.default, fa = Nr.exports("log4js:appenders"), da = tu, Da = eo, pa = gu, Ea = hu,
    ma = to, ha = new Map;
...
const Ua = Nr.exports("log4js:main"), Wa = D.default, za = Wr({ proto: !0 }), Ka = tu, qa = hu,
    Ya = gu, Xa = Au.exports, Za = wa.exports, Qa = Ra, el = eo, tl = function (e, t) {
...
let fl = {
    appenders: {
        debug: {
            type: "stdout",
            layout: { type: "pattern", pattern: "[%d] > hvigor %p %c %[%m%]" }
        },
...
class Fl {
    ...
    configure(e) {
        const t = (0, Cl.getConfiguration)(), n = {
            appenders: { ...t.appenders, ...e.appenders },
...
const Al = Z, vl = gl(kr), Sl = gl(p.default), wl = gl(E.default),
    Ol = xr.HvigorLogger.getLogger("parse-json-util");
var bl;
!function(e){
    e[e.Char=0] = "Char", e[e.EOF=1] = "EOF", e[e.Identifier=2] = "Identifier"
}(bl || (bl = {}));
let _l, Bl, Pl, kl, xl, Nl, Il = "start", Tl = [], Rl = 0, Ml = 1, Ll = 0, jl = !1, $l = "default",
    Hl = "'", Jl = 1;
